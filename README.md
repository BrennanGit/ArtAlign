...
Canvas navigation is zoom-only in every view: pinch around a point on touchscreens or use the mouse wheel over the point you want to keep in focus. Single-pointer drags remain reserved for drawing and editing.
